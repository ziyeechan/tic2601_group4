...
module.exports = (router) => {
  ...
  router.get("/review/all", reviewController.findAllReviews);
  ...
  router.get("/review/restaurant/:restaurantID", reviewController.findReviewsByRestaurantID);

  // Endpoint to get all reviews for booking_id
  router.get("/review/booking/:bookingID", reviewController.findReviewsByBookingID);
